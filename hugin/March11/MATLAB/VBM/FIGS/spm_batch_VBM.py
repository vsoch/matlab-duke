...
#------SPM_BATCH_VBM.py---------------------------
#
# This script is used for running FIGS data through VBM.  The anatomical file should start with s*.img
# in the specified folder, and be the ONLY image of this type in the folder, otherwise the script
# will not work.  It finds this file and renames it to mprage.img/.hdr 
...
gmmodulation = "1"                              # This is the grey matter modulation: 1: affine&nonlinear (SPM default), 2: non-linear only
						...
						# The script will find the anatomical file in the MPRAGE folder and rename it mprage.img/.hdr
####!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!###############################################
