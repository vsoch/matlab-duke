...
experiment = "ShockAnti.01"                           #experiment name for qsub
...
subnums = ["266"]
#subnums = ["201",203","206","208","209","211","212","213","215","217","218","220","222","223","224","225","226","227","229","231","233","235","236","237","240","241","244","245","246","247","249","250","252","253","254","257","258","260","261","262","263","264","266","267","268","269","274","276"]
runs = [1]                   #[ run01 ] range cuts the last number off any single runs should still be in [ ] or can be runs=range(1,2)
anatfolder = "anat"          #anatomical folder to be used has been renamed to "anat"

# processing choices
shockrun = "yes"             #"yes" runs preprocessing and single subject analysis for faces, "no" skips
...
for subnum in subnums:
	...
	for run in runs:
		...
		tmp_job_file = tmp_job_file.replace( "SUB_SHOCKRUN_SUB", str(shockrun) )
		...
		tmp_job_fname = "_".join( ["SPM_SHANTI", subnum, runstr ] )
