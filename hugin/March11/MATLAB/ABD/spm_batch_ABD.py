...
template_f = file("spm_batch_ABD_TEMPLATE.sh")#job template location (on head node)
experiment = "ABD.01"                         #experiment name for qsub
...
#subnums = ["015","016","017","018","020","021","022","024","025","026","027","028","029","030","031","032"]
subnums = ["015"]
runs = [1]               #[ run01 ] range cuts the last number off any single runs should still be in [ ] or can be runs=range(1,2)
anatfolder = "axial_mprage"     #folder under Data/Subject/ that includes the anatomical dicom images.
...
for subnum in subnums:
	...
	for run in runs:
		...
		tmp_job_fname = "_".join( ["SPM_ABD", subnum, runstr ] )
