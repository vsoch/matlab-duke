...
subnums = ["20110224_12333"] #should be entered in quotes, separated by commas, to be used as strings
...
orderno = "2"                #This is the group of subjects order number (must submit 1 python / order number)
