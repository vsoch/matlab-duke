...
# ALL VARIABLES SHOULD HAVE BEEN READ IN BY SPMSETUP PYTHON - WHICH PRODUCES A FILE WITH ALL
# VARIABLES TO BE USED HERE, INCLUDING THE FINISHED .MAT SCRIPT TO BE SUBMIT FOR EACH SUBJECT
# 

# but here we should be able to input run relevant paths that will change...
    # should ask for some by default: and what about custom ones?
    # how do we split apart the matlabbatch?
        
# VARIABLES WE NEED TO SET HERE
# runtime variables from SPMSETUP
# subject ID
# SCRIPT TEMPLATE DIRECTORY NEEDS TO BE SET / COLLECTED HERE!
# input data folders? (get in other script?)
# set variables read from .mat
...
subnums = ["44444444_44444"] #should be entered in quotes, separated by commas, to be used as strings
...
facesfolder = "run004_03"    #folder with the faces functional data (in V00*.img/.hdr format)
cardsfolder = "run004_04"    #folder with the cards functional data (in V00*.img/.hdr format)
restfolder = "run004_02"     #folder with the rest functional data (in V00*.img/.hdr format)
orderno = "4"                #This is the group of subjects order number (must submit 1 python / order number)
