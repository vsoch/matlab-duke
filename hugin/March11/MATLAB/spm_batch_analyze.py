...
#------SPM_BATCH_ANALYZE.py---------------------------
#
# This script is used for preprocessing of anatomical and functional data
# in SPM for the first 20 subjects with analyze raw files.
#
...
template_f = file("spm_batch_analyze_TEMPLATE.sh")      #job template location (on head node)
...
subnums = ["20100215_10344"] #should be entered in quotes, separated by commas, to be used as strings
...
facesfolder = "run004_03/NiftiHeaders/images"    #folder with the faces functional data (in V00*.img/.hdr format)
cardsfolder = "run004_04/NiftiHeaders/images"    #folder with the cards functional data (in V00*.img/.hdr format)
restfolder = "run004_02/NiftiHeaders/images"     #folder with the rest functional data (in V00*.img/.hdr format)
orderno = "4"                                    #this is the order number for the group of subjects
...
justfunc = "no"             #"yes" skips over anatomical processing / segmentation, right into func processing
