...
template_f = file("spm_cards_TEMPLATE.sh")      #job template location (on head node)
...
subnums = ["20100226_10401","20100405_10650","20100409_10689","20100507_10846"] #should be entered in quotes, separated by commas, to be used as strings
...
for subnum in subnums:
	...
	for run in runs:
		...
		tmp_job_fname = "_".join( ["SPM_CARDS", subnum, runstr ] )
