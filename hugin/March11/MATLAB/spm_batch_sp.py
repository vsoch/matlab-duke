...
subnums = ["20100409_10689"] #should be entered in quotes, separated by commas, to be used as strings
...
tone = ""             #t1 folder (series005) if it doesn't exist, leave blank
facesfolder = "run003_02"    #folder with the faces functional data (in V00*.img/.hdr format)
cardsfolder = "run003_03"    #folder with the cards functional data (in V00*.img/.hdr format)
restfolder = ""     #folder with the rest functional data (in V00*.img/.hdr format)
