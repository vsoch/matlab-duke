...
#----------first_level_FEAT_INDIVIDUAL.sh-----------
...
#>  [user@head ~]$ qsub -v EXPERIMENT=Dummy.01 first_level_FEAT_Individual.sh    3        4     Individual     run01    34565434   
...
EVDIR=$EXPERIMENT/Analysis/FACES/EVs/$DESIGN/$SUBJ
