...
# Output goes under Analysis/DESIGN_NAME/DTI/SUBJECT/SUBJECT.bedpostX
...
# all changes are done in the python script, BedpostX.py!
...
DTI_FOLDER=SUB_DTIFOLDER_SUB # This is the name of the DTI directory under Data/$SUBJECT
