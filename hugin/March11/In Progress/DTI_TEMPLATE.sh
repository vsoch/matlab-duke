...
bet $DTIDIR/DTI/data_corrected $DTIDIR/BET/datac_brain -F -f .225
    
#Running dtifit with input data, brain mask, output directory, bvecs and bval files
dtifit -k $DTIDIR/DTI/data_corrected.nii -m $DTIDIR/BET/datac_brain_mask.nii -o $DTIDIR/DTI/DTI -r $DTIDIR/.bvec -b $DTIDIR/.bval
