...
template_f = file("first_level_FEAT_FIGS_TEMPLATE.sh")  #job template location (on head node)
...
subnums = ["040706095946"] #should be entered in quotes, separated by commas, to be used as strings
...
anatdir = "3" #the folder name that contains the anatomical data
funcdir = "4" #the folder name that contains the functional data
designvar = "SplitBlockThree" #the name of the experiment design (for FIGS, 4Block, 4BlockMixed, Individual, etc)
designtype = "SplitblockThree" #the name of the design type under FACES
####!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
###############################################
