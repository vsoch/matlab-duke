...
mkdir -p $EXPERIMENT/Analysis/NEWFACES/First_level/$DESIGNTYPE/$SUBJ
...
ANAT=$ANATDIRECTORY/BET/anat_brain.nii
TEMPLATEDIR=$EXPERIMENT/Analysis/NEWFACES/First_level/Design/$DESIGNTYPE
EVDIR=$EXPERIMENT/Analysis/NEWFACES/EVs/$DESIGNTYPE
OUTDIR=$EXPERIMENT/Analysis/NEWFACES/First_level/$DESIGNTYPE/$SUBJ
