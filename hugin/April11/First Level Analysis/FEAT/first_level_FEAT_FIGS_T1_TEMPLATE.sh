...
RUN=SUB_RUNNAME_SUB
SUBJ=SUB_SUBNUM_SUB
T_ONEDIRECTORY=SUB_T_ONE_NAME_SUB

#make directory to put the output FEAT
mkdir -p $EXPERIMENT/Analysis/FACES/First_level/$DESIGNTYPE/$SUBJ
...
T_ONEDIR=$EXPERIMENT/Data/$SUBJ/$T_ONEDIRECTORY
