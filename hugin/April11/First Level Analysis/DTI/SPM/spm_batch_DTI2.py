...
subnums = ["20101104_11739","20101104_11736"] #should be entered in quotes, separated by commas, to be used as strings
...
dtifolder1 = "series007"     #folder under Data/Anat that includes the first set of raw dw images.
dtifolder2 = "series008"     #folder under Data/Anat that incudes the second set of raw dw images
