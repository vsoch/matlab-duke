...
# This script makes puts the BXH in the subject's /Data/RawData/$SUBJECT/4 folder in a folder called BXH

# -------- SUBMITTING JOB ON COMMAND LINE --------------
 
# >  qsub -v EXPERIMENT=FIGS.01 dicom2bxh.sh bxh_header 4 Subject1 Subject2 Subject3
...
# FOLDER is the folder in "Subject" that contains the functional data
