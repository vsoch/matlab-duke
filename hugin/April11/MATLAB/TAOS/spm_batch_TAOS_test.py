...
template_f = file("spm_batch_TAOS_template.sh")      #job template location (on head node)
...
subnums = ["EI0008"] #should be entered in quotes, separated by commas, to be used as strings
runs = [1]               #[ run01 ] range cuts the last number off any single runs should still be in [ ] or can be runs=range(1,2)
anatfolder = "T2"     #folder under Data/Anat that includes the anatomical dicom images.
