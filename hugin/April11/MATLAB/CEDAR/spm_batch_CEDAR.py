...
# in SPM for all (15!) CEDAR subjects.  To run everything, imagepreponly and funconly
...
# rrealigned the AC-PC, done segmentation manually, rename the c1* .img/.hdr to c1mprage
# .img/.hdr and, run with "imagepreponly" set to "no" and "funconly" - "yes"
#
...
template_f = file("spm_batch_CEDAR_TEMPLATE.sh")#job template location (on head node)
experiment = "CEDAR.01"                         #experiment name for qsub
...
#subnums15 = ["202","205","210","214","219","222","223","227","228","230","232","234","236","241","245"]
#subnums = ["212","216","240","246","247","248","254","256","261","265","268","270","273","278","281","282","284","297","298","299","300","301","302","306","307","315","317"]
subnums = ["212","299","317","302","247"]
runs = [1]               #[ run01 ] range cuts the last number off any single runs should still be in [ ] or can be runs=range(1,2)
anatfolder = "mprage"     #folder under Data/Subject/ that includes the anatomical dicom images.
...
for subnum in subnums:
	...
	for run in runs:
		...
		tmp_job_fname = "_".join( ["SPM_CEDAR", subnum, runstr ] )
