...
outputfolder="lAMY_11reg_200"    # This is the name that you would like for the output folder under "Analyzed/Subject/PPI"
...
ordernumber ="4"               # This is the order number that will specify the matrix weights for each subject
