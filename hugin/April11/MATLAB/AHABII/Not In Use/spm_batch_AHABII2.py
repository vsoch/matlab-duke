...
template_f = file("spm_batch_AHABII_template.sh")      #job template location (on head node)
...
subnums = ["55874_scandata"] #should be entered in quotes, separated by commas, to be used as strings
