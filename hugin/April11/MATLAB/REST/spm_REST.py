...
# data to run a connectivity analysis with the conn toolbox from MIT.
# 
...
template_f = file("spm_REST.sh")      #job template location (on head node)
...
subnums = ["TEST2"] #should be entered in quotes, separated by commas, to be used as strings
...
rois = "'BilatDLPFC_36_27_29_6mm.img' 'BilatPrecuneus_7_-60_21_6mm.img' 'BilatSgACC_10_35_-2_6mm.img'"
...
for subnum in subnums:
	...
	for run in runs:
		...
		tmp_job_fname = "_".join( ["CONN_REST", subnum, runstr ] )
