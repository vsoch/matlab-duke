...
SUBJECTS="040526133543 040527122743 040527142438 040602120431 040622101350 040622114122 040624091727 040624110344"
...
PATHTOPRINT=$COPEDIR/cope$COPE/Cluster_$MASK/$SUBJ/fq_$MASK/report.txt
echo "$SUBJ "
cat $PATHTOPRINT

FILEPATHS="$FILEPATHS $PATHTOPRINT "
