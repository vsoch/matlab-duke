...
switch design
 case 'Mixed'
  ...
  case 'Individual'
    scriptname1=horzcat('FIGS_pfl_',subj);
    scriptname1=horzcat('FIGS_',subj);
  otherwise
...
switch design
 case '4Block'
  ...
  case 'Individual'
      disp('Individual design detected - Vanessa hasnt figured this out yet!')
  otherwise
...
% WORK NEEDED HERE
%Need to select and copy art regression file name here to consistent name!
