...
% processing in spm_batch2.m, we delete the copied data and preprocessed
...
if strcmp('SUB_RUNCARDS_SUB', 'yes')
    if isdir('cards')==0
        ...
        if isdir ('SUB_CARDSFOLDER_SUB')==0
            sprintf('%s','Cards data for this subject does not exist.')
            return
            else
        copyfile(horzcat(datadir,'Func/SUB_SUBJECT_SUB/SUB_CARDSFOLDER_SUB/*'),(horzcat(homedir,'Processed/SUB_SUBJECT_SUB/cards/')))
        end
    else
        cd(horzcat(datadir,'Func/SUB_SUBJECT_SUB'))
        if isdir ('SUB_CARDSFOLDER_SUB')==0
...
if strcmp('SUB_RUNREST_SUB', 'yes')
    if isdir('rest')==0
        mkdir rest
        cd(horzcat(datadir,'Func/SUB_SUBJECT_SUB'))
        if isdir ('SUB_RESTFOLDER_SUB')==0
            sprintf('%s','Resting BOLD data for this subject does not exist.')
            return
        else
            copyfile(horzcat(datadir,'Func/SUB_SUBJECT_SUB/SUB_RESTFOLDER_SUB/*'),(horzcat(homedir,'Processed/SUB_SUBJECT_SUB/rest/')))
        end
    else
        cd(horzcat(datadir,'Func/SUB_SUBJECT_SUB'))
        if isdir ('SUB_RESTFOLDER_SUB')==0
...
if isdir('SUB_TFOLDER_SUB')==0
    ...
    if strcmp('SUB_TFOLDER_SUB', 'series005')
        matlabbatch{2}.spm.util.dicom.data = {
                                      ...
                                      'SUB_MOUNT_SUB/Data/Anat/SUB_SUBJECT_SUB/SUB_TFOLDER_SUB/SUB_DICOMTWO_SUB_00147.dcm'
                                      'SUB_MOUNT_SUB/Data/Anat/SUB_SUBJECT_SUB/SUB_TFOLDER_SUB/SUB_DICOMTWO_SUB_00148.dcm'
                                      'SUB_MOUNT_SUB/Data/Anat/SUB_SUBJECT_SUB/SUB_TFOLDER_SUB/SUB_DICOMTWO_SUB_00149.dcm'
                                      'SUB_MOUNT_SUB/Data/Anat/SUB_SUBJECT_SUB/SUB_TFOLDER_SUB/SUB_DICOMTWO_SUB_00150.dcm'
                                      'SUB_MOUNT_SUB/Data/Anat/SUB_SUBJECT_SUB/SUB_TFOLDER_SUB/SUB_DICOMTWO_SUB_00151.dcm'
                                      'SUB_MOUNT_SUB/Data/Anat/SUB_SUBJECT_SUB/SUB_TFOLDER_SUB/SUB_DICOMTWO_SUB_00152.dcm'
                                      'SUB_MOUNT_SUB/Data/Anat/SUB_SUBJECT_SUB/SUB_TFOLDER_SUB/SUB_DICOMTWO_SUB_00153.dcm'
                                      'SUB_MOUNT_SUB/Data/Anat/SUB_SUBJECT_SUB/SUB_TFOLDER_SUB/SUB_DICOMTWO_SUB_00154.dcm'
                                      'SUB_MOUNT_SUB/Data/Anat/SUB_SUBJECT_SUB/SUB_TFOLDER_SUB/SUB_DICOMTWO_SUB_00155.dcm'
                                      'SUB_MOUNT_SUB/Data/Anat/SUB_SUBJECT_SUB/SUB_TFOLDER_SUB/SUB_DICOMTWO_SUB_00156.dcm'
                                      'SUB_MOUNT_SUB/Data/Anat/SUB_SUBJECT_SUB/SUB_TFOLDER_SUB/SUB_DICOMTWO_SUB_00157.dcm'
                                      'SUB_MOUNT_SUB/Data/Anat/SUB_SUBJECT_SUB/SUB_TFOLDER_SUB/SUB_DICOMTWO_SUB_00158.dcm'
                                      'SUB_MOUNT_SUB/Data/Anat/SUB_SUBJECT_SUB/SUB_TFOLDER_SUB/SUB_DICOMTWO_SUB_00159.dcm'
                                      'SUB_MOUNT_SUB/Data/Anat/SUB_SUBJECT_SUB/SUB_TFOLDER_SUB/SUB_DICOMTWO_SUB_00160.dcm'
                                      'SUB_MOUNT_SUB/Data/Anat/SUB_SUBJECT_SUB/SUB_TFOLDER_SUB/SUB_DICOMTWO_SUB_00161.dcm'
                                      'SUB_MOUNT_SUB/Data/Anat/SUB_SUBJECT_SUB/SUB_TFOLDER_SUB/SUB_DICOMTWO_SUB_00162.dcm'
                                      };
    end
