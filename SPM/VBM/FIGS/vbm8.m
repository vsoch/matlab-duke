...
% Go to subject folder and create Scripts output directory if it doesn't
% exist
cd('SUB_MOUNT_SUB/Analysis/SPM/Processed/SUB_SUBJECT_SUB/')
if exist('Scripts','dir')==0
    mkdir Scripts
end
...
matlabbatch{1}.spm.tools.vbm8.estwrite.data = {'SUB_MOUNT_SUB/Analysis/SPM/Processed/SUB_SUBJECT_SUB/SUB_ANATFOLDER_SUB/mprage.img,1'};
...
matlabbatch{1}.spm.tools.vbm8.estwrite.output.WM.modulated = SUB_GMMODULATION_SUB;
...
if strcmp('SUB_GMMODULATION_SUB','1')
    ...
    matlabbatch{2}.spm.spatial.smooth.data = {'SUB_MOUNT_SUB/Analysis/SPM/Processed/SUB_SUBJECT_SUB/anat/mwp1mprage.nii,1'};
    matlabbatch{2}.spm.spatial.smooth.fwhm = [12 12 12];
    matlabbatch{2}.spm.spatial.smooth.dtype = 0
    matlabbatch{2}.spm.spatial.smooth.im = 0;
    matlabbatch{2}.spm.spatial.smooth.prefix = 's';

    matlabbatch{3}.spm.spatial.smooth.data = {'SUB_MOUNT_SUB/Analysis/SPM/Processed/SUB_SUBJECT_SUB/anat/mwp2mprage.nii,1'};
...
if strcmp('SUB_GMMODULATION_SUB','2')
    ...
    matlabbatch{2}.spm.spatial.smooth.data = {'SUB_MOUNT_SUB/Analysis/SPM/Processed/SUB_SUBJECT_SUB/anat/m0wp1mprage.nii,1'};
    matlabbatch{2}.spm.spatial.smooth.fwhm = [12 12 12];
    matlabbatch{2}.spm.spatial.smooth.dtype = 0;
    matlabbatch{2}.spm.spatial.smooth.im = 0;
    matlabbatch{2}.spm.spatial.smooth.prefix = 's';

    matlabbatch{3}.spm.spatial.smooth.data = {'SUB_MOUNT_SUB/Analysis/SPM/Processed/SUB_SUBJECT_SUB/anat/m0wp2mprage.nii,1'};
    matlabbatch{3}.spm.spatial.smooth.fwhm = [12 12 12];
    matlabbatch{3}.spm.spatial.smooth.dtype = 0;
    matlabbatch{3}.spm.spatial.smooth.im = 0;
    matlabbatch{3}.spm.spatial.smooth.prefix = 's';
