...
for i in hcoords.c minmax.c scaled2rgb.c trilinear.c; do
  echo "Building $i"
  echo "  mex $i"
  mex $i
done
...
echo "  mex -I$LIBXML2DIR/include/libxml2 -L$LIBXML2DIR/lib -lxml2 readxml.c"
mex -I$LIBXML2DIR/include/libxml2 -L$LIBXML2DIR/lib -lxml2 readxml.c

echo "Buildng writexml"
echo "  mex -I$LIBXML2DIR/include/libxml2 -L$LIBXML2DIR/lib -lxml2 writexml.c"
mex -I$LIBXML2DIR/include/libxml2 -L$LIBXML2DIR/lib -lxml2 writexml.c
