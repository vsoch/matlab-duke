...
spm_change_paths_swd_reverse('/ramSUB_MOUNT_SUB/Analysis/SPM/Analyzed/SUB_SUBJECT_SUB/Faces/','SUB_MOUNT_SUB/','N:/FIGS.01/','N:\FIGS.01\Analysis\SPM\Analyzed\SUB_SUBJECT_SUB\Faces\','/')
...
allfaces_matrix=[1,1,-1;2,1,1;3,1,1];
...
cd(horzcat(homedir,'Analyzed/SUB_SUBJECT_SUB/PPI/SUB_CONTRAST_SUB/SUB_OUTPUT_SUB/'));
spm_change_paths_swd('SUB_MOUNT_SUB/','SUB_MOUNT_SUB/','N:/FIGS.01/','/');
